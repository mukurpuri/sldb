  ...
  render() {
    ...
    return (
      <div className="componentDemo">
        ...
        <h3 className="slds-m-top_x-large">Press <span className="code-key slds-m-left--small  slds-m-right--small">{window.navigator.userAgent.indexOf("Mac") !== -1 ? "Cmd" : "Ctrl"} + Shift + N</span> to work in a new page</h3>
      </div>
    );
  }
}
